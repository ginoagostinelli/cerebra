...
class Workflow(ABC):
    @abstractmethod
    def run(self, agents: List["Agent"], inputs: Any, context: Any = None, max_iterations: int = 10) -> Any:
        pass
...
class SequentialWorkflow(Workflow):
    ...
    def run(self, agents: List["Agent"], inputs: Any = None, context: Any = None, max_iterations: int = 10) -> Any:
        """
...
class ParallelWorkflow(Workflow):
    ...
    def run(self, agents: List["Agent"], inputs: Any = None, context: Any = None, max_iterations: int = 10) -> Dict[str, Any]:
        """
